  ...
  useEffect(() => {
    ...
    if (window.Telegram && window.Telegram.WebApp) {
      ...
      if (initData && initData.user && initData.user.username) {
        setUsernameTelegram(initData.user.username);
      } else {
        setUsernameTelegram("User"); // Default if username is not available
      }
    }
  }, []);
                  ...
                  <DrawerTrigger asChild>
                    <div>
                      ...
                      >
                        ...
                        <div className="absolute h-full w-full rounded-md  bg-black/55 z-20 flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className=" min-h-[171px] border-none min-w-[326px] w-full p-2">
                <h1 className="work-sans text-[11px] text-[#FEFEFF] font-medium">
                  Referrals
                </h1>
