          ...
          <div>
            <Fade>
              <div className="aqum flex flex-col gap-4 items-center">
                <h1 className="text-7xl text-[#D25804] font-extrabold aqum">
                  {user?.year}
                </h1>
            ...
            <Zoom>
              <div className="flex flex-col gap-2 items-center">
                <h1 className="capitalise text-lg font-bold text-white text-center py-3 aqum">
                  Here is your Reward
                </h1>
                ...
                <Card className="aqum flex w-56 h-[89px] mx-auto border-none flex-col rounded-xl items-center justify-center gap-2 p-3 bg-[#D25804] text-white">
                  <h1 className="">
                    <CountUp start={0} separator="," end={10000} />
                  </h1>
                  <h1>$SHARES</h1>
                </Card>
