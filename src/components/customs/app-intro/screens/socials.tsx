...
export const Socials = ({ telegram_id }: { telegram_id: string | null }) => {
    ...
    const socialHandles = [
        ...
        },
        {
            ...
            path: "https://t.me/ravegeniegames",
            tag: "Join",
            style: {
        ...
        },
        {
            ...
            path: "https://x.com/ravegeniegames?t=3f4KV8-X1_KHvNmbeMPlSA&s=09",
            tag: "Follow",
            style: {
                        ...
                        {socialHandles.map((handles) => (
                            <div key={handles.tag} className="flex flex-col items-center justify-around mb-6 gap-2 w-full">
                                ...
                                <Button
                                    ...
                                    className={`max-h-6 tahoma text-xs font-medium text-center mt-3  ${confirmedAccounts[handles.name]
                                        ? "bg-green-600 hover:bg-green-700"
                                        : actionTaken[handles.name]
                                            ? "bg-[#D25804] hover:bg-orange-600"
                                            : "bg-gray-400 cursor-not-allowed"
                                        }`}
                                    disabled={confirmedAccounts[handles.name] || !actionTaken[handles.name]}
                                >
                                    {confirmedAccounts[handles.name] ? "CONFIRMED" : "Confirm"}
                                </Button>
                            </div>
                        ))}
